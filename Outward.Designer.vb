...
Partial Class Outward
    ...
    Private Sub InitializeComponent()
        ...
        Btnsave.Location = New Point(707, 441)
        ...
        ' GtPssType
        ' 
        GtPssType.Anchor = AnchorStyles.None
        GtPssType.Location = New Point(342, 311)
        GtPssType.Name = "GtPssType"
        ...
        Dte.Location = New Point(342, 237)
        Dte.Name = "Dte"
        ...
        ' SlNoText
        ' 
        SlNoText.Anchor = AnchorStyles.None
        SlNoText.Location = New Point(342, 59)
        ...
        ' SlNo
        ' 
        SlNo.AccessibleRole = AccessibleRole.IpAddress
        SlNo.Anchor = AnchorStyles.None
        SlNo.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point)
        SlNo.Location = New Point(144, 59)
        SlNo.Name = "SlNo"
        SlNo.Size = New Size(201, 31)
        SlNo.TabIndex = 18
        SlNo.Text = "Sl. no."
        ' 
        ' Outward
